export default {
    translations: {
        ...
        'please_input_location' : 'Please, input the Location',
        'please_input_name' : 'Please, input the Name',
        'body': 'Body',
        'please_input_body': 'Please, input the Body',
        'please_input_status': 'Please, input the Status',
        'calls': 'Calls',
        'please_input_calls': 'Please, input the Calls',
        'interval': 'Interval',
        'please_input_interval': 'Please, input the Interval',
        'ips': 'IPs',
        'please_input_ips' : 'Please, input the IPs',
        'cache_name': 'Cache name',
        'please_input_cache_name': 'Please, input the Cache name',
        'time_to_live': 'Time to live',
        'please_input_time_to_live': 'Please, input the Time to live',
        'headers': 'Headers',
        'please_input_headers' : 'Please, input the Headers',
        'query_params': 'Query Params',
        'please_input_query_params': 'Please, input the Query Params',
        'cors': 'Cors',
        'please_input_cors': 'Please, input the Cors',
        'header': 'Header',
        'seconds': 'Seconds',
        'minutes': 'Minutes',
        'hours': 'Hours',
        'access_token_name': 'Access Token Name',
        'please_input_access_token_name': 'Please, input the Access Token Name',
        'client_id_name': 'Client ID Name',
        'please_input_client_id_name': 'Please, input the Client ID Name',
        'type_oauth': 'Type OAuth',
        'please_input_type_oauth': 'Please, input the Type OAuth',
        'authorize': 'Authorize',
        'validate': 'Validate',
        'private_key': 'Private Key',
        'please_input_private_key': 'Please, input the Private Key',
        'provider_id': 'Provider ID',
        'time_access_token': 'Access Token Time',
