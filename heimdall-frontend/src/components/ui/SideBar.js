                ...
                <Affix>
                    ...
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['apis']} style={!this.state.collapsed ? {width: '200px'} : {width: '80px'}}>
                        <Menu.Item key="apis" className="apis">
                            <SidebarLink to="/apis" label="APIs" icon="api" />
                        </Menu.Item>

                        <Menu.Item key="plans" className="plans">
                            <SidebarLink to="/plans" label="Plans" icon="profile" />
                        </Menu.Item>

                        <Menu.Item key="apps" className="apps">
                            <SidebarLink to="/apps" label="Apps" icon="appstore" />
                        </Menu.Item>

                        <Menu.Item key="access-tokens" className="accessToken">
                            <SidebarLink to="/tokens" label="Access Tokens" icon="key" />
                        </Menu.Item>

                        <Menu.Item key="environments" className="environments">
                            <SidebarLink to="/environments" label="Environments" icon="codepen" />
                        </Menu.Item>

                        <Menu.Item key="developers" className="developers">
                            <SidebarLink to="/developers" label="Developers" icon="code" />
                        </Menu.Item>

                        <Menu.Item key="users" className="users">
                            <SidebarLink to="/users" label="Users" icon="user" />
                        </Menu.Item>

                        <Menu.Item key="traces" className="traces">
                            <SidebarLink to="/traces" label="Traces" icon="sync" />
                        </Menu.Item>
                    </Menu>
                </Affix>
            </Sider>
